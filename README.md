...
- **Muted** — 🔇 Микрофон выключен - ПОСТОЯННОЕ уведомление
- **Disconnected** — 🔌 Устройство недоступно
- **VolumeChanged** — 🔊 Изменена громкость
- **DeviceChanged** — 🔄 Сменено устройство
- **PhysicallyDisconnected** — ❌ Физическое отключение
